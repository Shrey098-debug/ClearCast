...
const socket = io("https://b30f-2409-40d2-114e-ed08-442a-9a1b-4fd7-f293.ngrok-free.app"); // Ensure this is your current ngrok URL
        ...
        try {
            ...
            chunkIntervalRef.current = setInterval(() => {
                rec.exportWAV(blob => {
                    ...
                    const uploadUrl = 'https://b30f-2409-40d2-114e-ed08-442a-9a1b-4fd7-f293.ngrok-free.app/upload' +
